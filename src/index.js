...
/**
 * @param {string[]} args
 * @returns {{ id?: string, cwd?: string, capabilities?: string[], brain?: boolean, webhookPort?: number }}
 */
function parseArgs(args) {
  /** @type {{ id?: string, cwd?: string, capabilities?: string[], brain?: boolean, webhookPort?: number }} */
  const result = {};
...
// Parse args first so --help works without env vars
